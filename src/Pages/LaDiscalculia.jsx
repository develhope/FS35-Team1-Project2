...
const LaDiscalculia = () => {
  const sezioni = [
    {
      srcImg: "./assets/immagini/bambino dubbioso.svg",
      bg: "00AD68",
    ...
    {
      srcImg: "./assets/immagini/bambina libri.svg",
      bg: "FB8F20",
    ...
    {
      srcImg: "./assets/immagini/bambina dubbiosa.svg",
      bg: "EFD45A",
    ...
    {
      srcImg: "./assets/immagini/bambino.svg",
      bg: "5C9BFF",
