...
const Livello4Gioco1 = () => {
  return (
    <Struttura1Gioco
      ...
      posizioneAstronauti={{
         donna: { default: "top-[50px] left-[90px]", md: "md:top-[130px] md:left-[265px]",lg: "lg:top-[10px] lg:left-[510px] lg:w-[75px]" },
      maschio: { default: "top-[40px] left-[190px]", md: "md:top-[120px] md:left-[405px]",lg: "lg:top-[2px] lg:left-[590px] lg:w-[75px]"  },
      }}
    />
  );
};
