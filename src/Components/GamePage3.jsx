  ...
  return (
    <>
      ...
      <main className="flex flex-col justify-center items-center p-4">
        <GamePageSection title="Trova la coppia" />
        <GamePageSection title="Descrizione" content="La scimmietta astronauta ha una lista della spesa e deve raccogliere la quantità di frutti richiesta dalla mamma." />
