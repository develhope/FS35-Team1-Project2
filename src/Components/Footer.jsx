const Footer = () => {
  ...
  <img src="immagini/icon/facebook.svg" alt="Facebook" className="w-7" />
 <img src="immagini/icon/twitter.svg" alt="Twitter" className="w-7" />
 <img src="immagini/icon/tiktok.svg" alt="Tiktok" className="w-7" />
 <img src="immagini/icon/instagram.svg" alt="Instagram" className="w-7" />
